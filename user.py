...
def main_page():
    ...
    switch_2 = ctk.CTkSwitch(animated_panel, text="Fire Detection",font=("arial",13), variable=switch_var_2,onvalue="on",offvalue="off")
    ...
    gen_button.place(relx=0.48,rely=0.87,anchor="n")
